...
def get_parameters(cfg: DictConfig):
    ...
    last_checkpoint = f"{cfg.general.save_dir}/last_model.pth"
    if (
        cfg.general.train_mode
        and cfg.trainer.resume_from_checkpoint is None
        and os.path.isfile(last_checkpoint)
    ):
        print(f"Resuming training from {last_checkpoint}")
        cfg.trainer.resume_from_checkpoint = last_checkpoint
